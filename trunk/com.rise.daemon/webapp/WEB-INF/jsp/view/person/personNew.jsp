...
<body>
	<div class="container">
		...
		<div id="menubar" style="width: auto">
			<ul id="menu">
				<%
					List<String> activeTabsList = (List<String>) request
							.getAttribute(HibernateHelperConstants.ACTIVE_TABS_LIST);
					String className = (String) request.getAttribute("className");
				%>
				<c:if test="${not empty activeTabsList}">
					<c:forEach items="${activeTabsList}" var="tabName"
						varStatus="index">
						<li><a name="${tabName}" href="/rise/${fn:toLowerCase(tabName) }/list"
		...
		<form:form modelAttribute="<%=className %>" action="save" method="post">
