...
<body>
	<div class="container">
		...
		<form:form modelAttribute="award" action="/award/save" method="post">
							...
							<table>
								<tr>
									...
									<td><form:input path="person.id"
											value="${award.getPerson().getId() }" /></td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><form:input path="issuedBy" /></td>
								</tr>
								<tr>
									...
									<td><form:input path="dateIssued" /></td>
								</tr>
								<tr>
