...
public class Extract {
	...
	public static void main(String[] args) {
		...
		Map<String, String> nameVsEmailUrlMap = collectUrls
				.getNameVsEmailUrlMap("http://facultybio.haas.berkeley.edu");
		Precondition.ensureNotEmpty(nameVsEmailUrlMap, "Name Vs Email URL Map");
	...
	public void write(List<User> argUsersList) {
		...
		try {
			CsvWriter csvWriter = new CsvWriter("./output/berkeley/" + "berkeley" + ".csv");
