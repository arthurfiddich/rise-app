...
<body>
	<div class="container">
		...
		<form:form modelAttribute="editEmploymentExperience"
			action="/employmentexperience/update" method="post">
			<form:input path="id" value="${editEmploymentExperience.getId()}"
				type="hidden" />
							...
							<table>
								<tr>
									...
									<td><form:input path="person.id"
											value="${editEmploymentExperience.getPerson().getId() }" />
									</td>
								</tr>
								<tr>
									...
									<td><form:input path="jobTitle"
											value="${editEmploymentExperience.getJobTitle()}" />
									</td>
								</tr>
								<tr>
									...
									<td><form:input path="fromDate"
											value="${editEmploymentExperience.getFromDate()}" /></td>
								</tr>
								<tr>
									...
									<td><form:input path="toDate"
											value="${editEmploymentExperience.getToDate()}" />
									</td>
								</tr>
								<tr>
									...
									<td><form:input path="description"
											value="${editEmploymentExperience.getDescription()}" />
									</td>
								</tr>
							</table></td>
					</tr>
