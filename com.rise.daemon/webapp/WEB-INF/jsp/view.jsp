...
<body>
	...
	<c:if test="${!empty addressView}">
		<table class="data">
			...
			<tr>
				<td>${addressView.id }</td>
				<td>${addressView.streetAddress }</td>
				<td>${addressView.city }</td>
				<td>${addressView.state }</td>
				<td>${addressView.postalCode }</td>
				<td>${addressView.country }</td>
			</tr>
		</table>
	</c:if>
</body>
